...
`new Cesium.ScreenSpaceEventHandler(element)`,[ScreenSpaceEventHandler 官方文档](https://cesium.com/learn/cesiumjs/ref-doc/ScreenSpaceEventHandler.html?classFilter=ScreenSpaceEventHandler)
