...
2. 使用`Cesium.GeoJsonDataSource`加载 GeoJSON 数据
...
6. 通过`Cesium.BoundingSphere`计算实体的包围球
7. 使用`Cesium.CullingVolume`进行视锥体裁剪，优化标签显示
...
<script setup>
import Demo from '@/Components/进阶/06_沿线标注.vue'
</script>
