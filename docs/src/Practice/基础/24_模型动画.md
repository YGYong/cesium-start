...
1. 使用`viewer.trackedEntity`属性可以将相机绑定到实体上,实现相机跟随实体移动
2. 使用`viewFrom`设置一个合适的位置观察模型

<video controls width="600">
  <source src="../../Aassets/Basics/08_模型动画.mp4" type="video/mp4" />
  您的浏览器不支持HTML5视频标签。
</video>
...
<Demo />
<script setup>
import Demo from '@/Components/基础/24_模型动画.vue'
</script>